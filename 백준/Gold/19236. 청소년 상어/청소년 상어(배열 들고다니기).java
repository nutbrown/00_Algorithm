...
public class Main {
    ...
    // 배열 크기가 작고, 원상복구가 어려워서, 다 들고 다닌다
    static void dfs(int[][] map, int[][] fishes, int sum) {
    	// 최댓값 갱신
    	...
    	for(int i = 1; i < 4; i++) {
    		...
    		if(map[nr][nc] != 0) {
    	    	...
    	    	// 다음 (물고기 움직이고) 상어 움직이기
    			dfs(tempMap, tempFishes, sum + fish);
